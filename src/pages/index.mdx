...
with my friends and <a href={props.data.molly.url} title={props.data.molly.name}>partner</a>. I
also love spending time visiting with my family, including my baby nephew [Landon][landon], and
Harper.
